...
import { getDocument  , deleteImages, uploadImages} from "@/functions/firebase/getData";
...
const imagesToDelete = product.images.filter((image)=>!values.images.includes(image))
