...
const Support = () => {
  return (
    <div>
      <SimpleGrid spacing={10} columns={[1, 1, 2, 4]} mb={10}>
        ...
        <Card p={22} className=" !shadow-lg">
          <Flex gap={10} mx={15}>
            ...
            <Box>
              <p className="text-xl font-bold">You Can Pay USDT</p>

              <p className="text-sm">Make your order and Pay Cryptocurrency Tether (Usdt)</p>
            </Box>
          </Flex>
        </Card>
